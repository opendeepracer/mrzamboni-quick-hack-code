...
(cl:defmethod cl:initialize-instance :after ((m <InferResults>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InferResults)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mrinfer-msg:<InferResults> is deprecated: use mrinfer-msg:InferResults instead.")))

(cl:ensure-generic-function 'classLabel-val :lambda-list '(m))
(cl:defmethod classLabel-val ((m <InferResults>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrinfer-msg:classLabel-val is deprecated.  Use mrinfer-msg:classLabel instead.")
  (classLabel m))

(cl:ensure-generic-function 'classProb-val :lambda-list '(m))
(cl:defmethod classProb-val ((m <InferResults>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrinfer-msg:classProb-val is deprecated.  Use mrinfer-msg:classProb instead.")
  (classProb m))

(cl:ensure-generic-function 'xMin-val :lambda-list '(m))
(cl:defmethod xMin-val ((m <InferResults>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrinfer-msg:xMin-val is deprecated.  Use mrinfer-msg:xMin instead.")
  (xMin m))

(cl:ensure-generic-function 'yMin-val :lambda-list '(m))
(cl:defmethod yMin-val ((m <InferResults>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrinfer-msg:yMin-val is deprecated.  Use mrinfer-msg:yMin instead.")
  (yMin m))

(cl:ensure-generic-function 'xMax-val :lambda-list '(m))
(cl:defmethod xMax-val ((m <InferResults>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrinfer-msg:xMax-val is deprecated.  Use mrinfer-msg:xMax instead.")
  (xMax m))

(cl:ensure-generic-function 'yMax-val :lambda-list '(m))
(cl:defmethod yMax-val ((m <InferResults>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrinfer-msg:yMax-val is deprecated.  Use mrinfer-msg:yMax instead.")
  (yMax m))
