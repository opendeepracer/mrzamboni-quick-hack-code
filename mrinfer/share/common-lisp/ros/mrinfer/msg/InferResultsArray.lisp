...
(cl:defclass <InferResultsArray> (roslisp-msg-protocol:ros-message)
  ((results
    :reader results
    :initarg :results
    :type (cl:vector mrinfer-msg:InferResults)
   :initform (cl:make-array 0 :element-type 'mrinfer-msg:InferResults :initial-element (cl:make-instance 'mrinfer-msg:InferResults)))
   (img
    :reader img
    :initarg :img
...
(cl:defmethod cl:initialize-instance :after ((m <InferResultsArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InferResultsArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mrinfer-msg:<InferResultsArray> is deprecated: use mrinfer-msg:InferResultsArray instead.")))

(cl:ensure-generic-function 'results-val :lambda-list '(m))
(cl:defmethod results-val ((m <InferResultsArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrinfer-msg:results-val is deprecated.  Use mrinfer-msg:results instead.")
  (results m))

(cl:ensure-generic-function 'img-val :lambda-list '(m))
(cl:defmethod img-val ((m <InferResultsArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mrinfer-msg:img-val is deprecated.  Use mrinfer-msg:img instead.")
  (img m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <InferResultsArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'results)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'mrinfer-msg:InferResults))
